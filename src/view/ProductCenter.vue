<template>
    <div>
        ...
        <div class="content">
            <div style="width: 100%;padding: 32px 260px;display: flex;justify-content: space-between;flex-wrap: wrap;">
                <div v-for="(item ,index) in goodsList[checkNav].goods" :key="index" style="width: 324px;height: 412px;margin-bottom: 32px;">
